...
@include('backend.articles.be_form_search_articles_view')
...
<div class="row">
        ...
        <div class="block">
            <div class="header">
                ...
                <div class="side pull-right">                            
                    <ul class="buttons">                                
                        <li><a href="{!! route('be-create-article.show')!!}"><span class=" btn btn-success icon-plus tip" title data-original-title="Create a new article"> Create</span></a></li>
    ...
    <a href="{!! route('be-ajaxsearch-article.show') !!}" title="" id="search-paginate"></a>
    <script src="/backend/my-js/be_articles.js"></script>
</div>
@stop
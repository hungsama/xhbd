...
<head>        
    ...
    <link href="/backend/css/stylesheets.css" rel="stylesheet" type="text/css" />        
    ...
    <script type='text/javascript' src='/backend/js/plugins/jquery/jquery-migrate.min.js'></script>
    <script type='text/javascript' src='/backend/js/plugins/jquery/globalize.js'></script>    
    <script type='text/javascript' src='/backend/js/plugins/bootstrap/bootstrap.min.js'></script>
    
    <script type='text/javascript' src='/backend/js/plugins/uniform/jquery.uniform.min.js'></script>

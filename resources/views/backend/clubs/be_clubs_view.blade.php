...
<div class="row">
        ...
        <div class="block">
            <div class="header">
                ...
                <div class="side pull-right">                            
                    <ul class="buttons">                                
                        <li><a href="{!! route('be-create-club.show')!!}"><span class=" btn btn-success icon-plus tip" title data-original-title="Create a new article"> Create</span></a></li>
    ...
    <a href="{!! route('be-ajaxsearch-club.show') !!}" title="" id="search-paginate"></a>

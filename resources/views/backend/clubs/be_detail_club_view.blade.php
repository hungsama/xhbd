    ...
    <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="block">
            ...
            <div class="content controls">
                <form class="cmxform form-horizontal" id="signupForm" method="post" action="{!! route('be-update-club.show', $data['record']->id) !!}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="rank">
                                    ...
                                    @if (count($data['clubs']) > 0)
                                        ...
                                        <option value="{!! $k+1 !!}" @if($data['record']->rank == $cb->rank) selected @endif>{!! ($k+1).'-'.$cb->name !!}</option>
                                        @endforeach

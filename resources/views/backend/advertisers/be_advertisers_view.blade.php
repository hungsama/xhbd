...
<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>                    
            <li class="active"><a href="#">Advertisers</a></li>                                        
        </ol>
    </div>
</div>        

@include('backend.advertisers.be_form_search_advertisers_view')
...
<div class="row">
        ...
        <div class="block">
            <div class="header">
                ...
                <div class="side pull-right">                            
                    <ul class="buttons">                                
                        <li><a href="{!! route('be-create-advertiser.show')!!}"><span class=" btn btn-success icon-plus tip" title data-original-title="Create a new article"> Create</span></a></li>
    ...
    <a href="{!! route('be-ajaxsearch-advertiser.show') !!}" title="" id="search-paginate"></a>
    <script src="/backend/my-js/be_advertise.js"></script>
</div>
@stop
...
<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>                    
            <li class="active"><a href="{!! route('be-category.show')!!}">Category</a></li>                                        
        </ol>
    </div>
</div>
    ...
    <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="block">
            ...
            <div class="content controls">
                <form class="cmxform form-horizontal" id="signupForm" method="post" action="{!! route('be-save-category.show') !!}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="radiobox-inline custom">
                                <label style="margin-right: 35px;">
                                    <input type="radio" name="is_parent" value="1" onclick="changeParent(this.value, 0);" checked/> Yes
                                </label>
                                <label>
                                    <input type="radio" name="is_parent" value="0" onclick="changeParent(this.value, {!! (count($data['categories_parent'])>0)?$data['categories_parent'][0]->id:0 !!});"/> No
                                </label>
                            </div>                                
                        </div>
                    </div>

                    <div class="form-row" id="cate-parent" style="display:none;">
                        <div class="col-md-3">Belog to category</div>
                        <div class="col-md-6">
                            @if (count($data['categories_parent']) > 0)
                            <select class="form-control" name="parent" onchange="resetRank(this.value, 0);" id="parent">
                    ...
                    <div class="form-row" id="place-show">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="rank">
                                    ...
                                    @if (count($data['categories_parent']) > 0)
                                        @foreach( $data['categories_parent'] as $k=> $cate)
                                        <option value="{!! $k+1 !!}">{!! ($k+1).'-'.$cate->name !!}</option>
                                        @endforeach

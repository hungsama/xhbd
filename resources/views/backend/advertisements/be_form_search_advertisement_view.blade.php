<div class="row">
                ...
                <form id="makedinputs" action="#" method="post">
                    ...
                    <div class="col-md-3">
                        <div class="form-row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title" value="" class="form-control" id="title-search">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12" style="margin-top:10px;">
                        <div class="side pull-right">
                            <div class="btn-group">
                                <a class="btn btn-defult" href="{!! route('be-article.show') !!}"> Reset</a>
    ...
    <div class="col-md-12" id="search-hidden"  style="display:none">                
        <input type="hidden" name="title" value="" id="name-current">

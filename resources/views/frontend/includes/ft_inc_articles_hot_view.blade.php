@if($data['articlesHotPlace'] == 'main')
<div class="kode-blog-list kode-grid-blog">
    @if ($data['articlesHot'])
    <ul class="row">
        @foreach($data['articlesHot'] as $k => $r)
        <!-- {!! var_dump($r) !!} -->
        <li class="col-md-6">
